...
namespace NGToolsEditor.NGConsole
{
	internal sealed class FontSize14Theme : Theme
	{
		public override void	SetTheme(NGSettings instance)
		{
			...
			stackTrace.previewSourceCodeStyleOverride.fontSize = 14;
		}
	}
}