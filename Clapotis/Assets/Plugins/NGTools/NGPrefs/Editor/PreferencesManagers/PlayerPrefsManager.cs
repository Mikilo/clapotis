	...
	internal sealed class PlayerPrefManager : PrefsManager
	{
		...
		public override void	LoadPreferences()
		{
			if (Application.platform == RuntimePlatform.WindowsEditor)
			{
				...
				this.LoadFromRegistrar(@"SOFTWARE\" + (unityVersion[0] == '2' || (unityVersion[0] == '5' && (unityVersion[2] == '5' || unityVersion[2] == '6')) ? @"Unity\UnityEditor\" : string.Empty) + PlayerSettings.companyName + @"\" + PlayerSettings.productName);
			}
