...
namespace NGToolsEditor.NGComponentsInspector
{
	...
	public class NGComponentsInspectorWindow : EditorWindow, IHasCustomMenu
	{
		...
		public static Color	TitleColor = new Color(220F / 255F, 20F / 255F, 60F / 255F, 1F); // Crimson
		...
		[MenuItem(Constants.MenuItemPath + NGComponentsInspectorWindow.Title, priority = Constants.MenuItemPriority + 340), Hotkey(NGComponentsInspectorWindow.Title)]
		public static void	Open()
		{
			Utility.OpenWindow<NGComponentsInspectorWindow>(NGComponentsInspectorWindow.ShortTitle);
		}
		...
		{
			Utility.AddNGMenuItems(menu, this, NGComponentsInspectorWindow.Title, NGAssemblyInfo.WikiURL);
		}
	}
}