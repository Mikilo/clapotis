...
namespace NGToolsEditor
{
	...
	internal sealed class GroupDrawer : PropertyDrawer
	{
		...
		public override float	GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			...
			float	height = Constants.SingleLineHeight; // Group name
		...
		private void	Initialize(SerializedProperty property)
		{
			...
			FieldInfo[]			fields = this.fieldInfo.DeclaringType.GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
			...
			{
				if (NGTools.Utility.CanExposeFieldInInspector(fields[i]) == false)
					continue;
