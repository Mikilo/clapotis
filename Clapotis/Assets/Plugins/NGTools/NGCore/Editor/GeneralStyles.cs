...
namespace NGToolsEditor
{
	public static class GeneralStyles
	{
		...
		public static GUIContent	StatusWheel
		{
			get
			{
				if (GeneralStyles.statusWheel == null)
				{
					GeneralStyles.statusWheel = new GUIContent[12];
					for (int i = 0; i < 12; i++)
						GeneralStyles.statusWheel[i] = new GUIContent(GeneralStyles.LoadRequiredIcon("WaitSpin" + i.ToString("00") + ".png"));
				}

				return GeneralStyles.statusWheel[(int)Mathf.Repeat((float)EditorApplication.timeSinceStartup * 10F, 11.99f)];
			}
		}
		...
		public static GUIStyle	SmallLabel
		{
			get
			{
				if (GeneralStyles.smallLabel == null)
				{
					...
					GeneralStyles.smallLabel.alignment = TextAnchor.MiddleLeft;
					GeneralStyles.smallLabel.fontSize = 9;
				}
		...
		public static GUIStyle	HorizontalCenteredText
		{
			get
			{
				if (GeneralStyles.horizontalCenteredText == null)
				{
					...
					GeneralStyles.horizontalCenteredText.alignment = TextAnchor.MiddleCenter;
					GeneralStyles.horizontalCenteredText.wordWrap = false;
				}
		...
		private static GUIStyle toolbarLeftButton;
		public static GUIStyle	ToolbarLeftButton
		{
			get
			{
				if (GeneralStyles.toolbarLeftButton == null)
				{
					GeneralStyles.toolbarLeftButton = new GUIStyle("ToolbarButton");
					GeneralStyles.toolbarLeftButton.alignment = TextAnchor.MiddleLeft;
				}

				return GeneralStyles.toolbarLeftButton;
			}
		}
		...
		private static GUIStyle	allCenterTitle;
		public static GUIStyle	AllCenterTitle
		{
			get
			{
				if (GeneralStyles.allCenterTitle == null)
				{
					GeneralStyles.allCenterTitle = new GUIStyle(EditorStyles.label);
					GeneralStyles.allCenterTitle.alignment = TextAnchor.MiddleCenter;
					GeneralStyles.allCenterTitle.fontStyle = FontStyle.Bold;
					GeneralStyles.allCenterTitle.fontSize = 14;
					GeneralStyles.allCenterTitle.margin.top = 0;
					GeneralStyles.allCenterTitle.margin.bottom = 0;
					GeneralStyles.allCenterTitle.margin.left = 0;
					GeneralStyles.allCenterTitle.margin.right = 0;
				}

				return GeneralStyles.allCenterTitle;
			}
		}
	}
}