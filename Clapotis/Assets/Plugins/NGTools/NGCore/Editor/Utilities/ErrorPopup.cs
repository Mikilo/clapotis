...
namespace NGToolsEditor
{
	public sealed class ErrorPopup : PopupWindowContent
	{
		...
		public	ErrorPopup(string tool, string customMessage = "", float height = 30F)
		{
			this.tool = tool;
		...
		public void	OnGUILayout()
		{
			...
			EditorGUILayout.BeginHorizontal();
			{
				...
				r.x = r.x + r.width + 1F;
				r.width = GUILayoutUtility.GetRect(25F, r.height, GUI.skin.button, GUILayoutOptionPool.Width(25F)).width + 4F;
				if (GUI.Button(r, "X") == true)
					this.ClearException();
			}
		...
		private void	HandleEvents(Rect r)
		{
			...
			if (Event.current.type == EventType.MouseMove &&
				EditorWindow.mouseOverWindow != null && // This error happened once in 5.6.0p2, I don't know how.
				r.Contains(Event.current.mousePosition) == true)
			{
