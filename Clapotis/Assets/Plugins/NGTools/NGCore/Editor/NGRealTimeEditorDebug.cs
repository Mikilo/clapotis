...
namespace NGToolsEditor
{
	public class NGRealTimeEditorDebug : EditorWindow
	{
		...
		public const string	Title = "NG Editor Debug";
		...
		protected virtual void	OnGUI()
		{
			...
			{
				this.play = EditorGUILayout.Toggle("Time " + EditorApplication.timeSinceStartup.ToString(), this.play);
			}
			...
			{
				Utility.content.text = this.vars[i].key;
