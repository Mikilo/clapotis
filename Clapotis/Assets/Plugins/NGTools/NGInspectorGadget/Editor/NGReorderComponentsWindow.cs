...
namespace NGToolsEditor.NGInspectorGadget
{
	...
	{
		public const string	Title = "NG Reorder Components";
		...
		{
			Metrics.UseTool(15); // NGReorderComponents
		...
		private void	DrawElement(Rect rect, int index, bool isActive, bool isFocused)
		{
			...
			EditorGUI.BeginDisabledGroup((this.components[index][0] is Transform));
			{
				if (this.components[index][0] is Behaviour && NGTools.Utility.IsComponentEnableable(this.components[index][0]) == true)
				{
					Rect	r = rect;
