...
namespace NGTools.NGRemoteScene
{
	public sealed class NetMethod
	{
		...
		public static void	Serialize(ByteBuffer buffer, ServerMethodInfo method)
		{
		...
		private	NetMethod(ByteBuffer buffer)
		{
			...
			this.returnTypeRaw = buffer.ReadUnicodeString();
			this.returnType = Type.GetType(this.returnTypeRaw);
		...
		{
			return this.name + " " + this.returnTypeRaw;
		}
	}
}